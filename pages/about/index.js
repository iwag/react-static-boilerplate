...
const renderSectionTitle = section => (
  <span>
    ...
    <span className={styles.pill}>{section.count}</span>
    <span className={styles.section_more}><a className={styles.title} href={"http://search.nicovideo.jp/"+section.type+"/search/"}>続きをみる</a></span>
</span>
);
